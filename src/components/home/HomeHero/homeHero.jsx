    ...
    return(
        <>
            <div className="homeHero_main">
                <div className="hhm_heading">
                    <h1>Profesionalūs apskaitos <br /> sprendimai Jūsų verslui</h1>
                </div>
                <div className="hhm_solutions">
                    <div className="hhmS_item">
                        <section>
                            <p>Lorem, ipsum.</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-arrow-down-left" viewBox="0 0 16 16">
                    ...
                    <div className="hhmS_circle">
                        <p>Apskaitos <br /> sprendimai <br /> visiems</p>
                    </div>
                </div>
            </div>
        </>
